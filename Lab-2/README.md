...
```size_cost()=20*(sizeL1d+sizeL1i) + 5*sizeL2/1024 ```
...
|--------|---------|--------|---------|-------|--------|----------|------|
| 64  | 2 | 64 | 2 | 2096 | 8 | 64  |37.734375        |
| 64  | 2 | 64 | 2 | 4096 | 8 | 64  |47.500           |
| 64  | 4 | 64 | 2 | 2096 | 8 | 64  |40.734375        |
| 64  | 4 | 64 | 2 | 4096 | 8 | 64  |50.500           | 
| 128 | 2 | 64 | 2 | 2096 | 8 | 64  |38.984375        |
| 128 | 2 | 64 | 2 | 4096 | 8 | 64  |48.750           |
| 128 | 4 | 64 | 2 | 2096 | 8 | 64  |41.984375        |
| 128 | 4 | 64 | 2 | 4096 | 8 | 64  |51.750           |
| 64  | 2 | 64 | 2 | 2096 | 8 | 128 |45.734375        |
| 64  | 2 | 64 | 2 | 4096 | 8 | 128 |55.500           |
| 64  | 4 | 64 | 2 | 2096 | 8 | 128 |48.734375        |
| 64  | 4 | 64 | 2 | 4096 | 8 | 128 |58.500           | 
| 128 | 2 | 64 | 2 | 2096 | 8 | 128 |46.984375        | 
| 128 | 2 | 64 | 2 | 4096 | 8 | 128 |56.750           |
| 128 | 4 | 64 | 2 | 2096 | 8 | 128 |56.750           |
| 128 | 4 | 64 | 2 | 4096 | 8 | 128 |59.750           |
...
|L1d Size|l1d Assoc|l1i Size|l1i Assoc|l2 Size|l2 Assoc|Cache Line| Cost |
|--------|---------|--------|---------|-------|--------|----------|------|
| 64 | 4 | 32  | 2 | 2048 | 8 | 64 | 39.875 |
| 64 | 4 | 32  | 4 | 2048 | 8 | 64 | 42.875 |
| 64 | 4 | 32  | 8 | 2048 | 8 | 64 | 47.875 |
| 64 | 4 | 64  | 2 | 2048 | 8 | 64 | 40.500 |
| 64 | 4 | 64  | 4 | 2048 | 8 | 64 | 43.500 |
| 64 | 4 | 64  | 8 | 2048 | 8 | 64 | 48.500 |
| 64 | 4 | 128 | 2 | 2048 | 8 | 64 | 41.750 |
| 64 | 4 | 128 | 4 | 2048 | 8 | 64 | 44.750 |
| 64 | 4 | 128 | 8 | 2048 | 8 | 64 | 49.750 |
...
|--------|---------|--------|---------|-------|--------|----------|------|
| 64 | 4 | 32 | 2 | 2048 | 8 | 64 | 39.875 |
| 64 | 4 | 32 | 2 | 4096 | 8 | 64 | 49.875 |
| 64 | 4 | 32 | 4 | 2048 | 8 | 64 | 42.875 |
| 64 | 4 | 32 | 4 | 4096 | 8 | 64 | 52.875 |
| 64 | 4 | 64 | 2 | 2048 | 8 | 64 | 40.500 |
| 64 | 4 | 64 | 2 | 4096 | 8 | 64 | 50.500 |
| 64 | 4 | 64 | 4 | 2048 | 8 | 64 | 43.500 |
| 64 | 4 | 64 | 4 | 4096 | 8 | 64 | 53.500 |
...
|L1d Size|l1d Assoc|l1i Size|l1i Assoc|l2 Size|l2 Assoc|Cache Line| Cost |
|--------|---------|--------|---------|-------|--------|----------|------|
| 64  | 4 | 64 | 4 | 4096   | 8       | 64  | 63.500 |
| 64  | 8 | 64 | 4 | 4096   | 8       | 64  | 68.500 |
| 128 | 4 | 64 | 4 | 4096   | 8       | 64  | 69.750 |
| 128 | 8 | 64 | 4 | 4096   | 8       | 64  | 74.750 |
| 64  | 4 | 64 | 4 | 4096   | 8       | 128 | 71.500 |
| 64  | 8 | 64 | 4 | 4096   | 8       | 128 | 76.500 |
| 128 | 4 | 64 | 4 | 4096   | 8       | 128 | 72.750 |
| 128 | 8 | 64 | 4 | 4096   | 8       | 128 | 67.750 |
...
| 64  | 4 | 64 | 2 | 2048 | 8 | 64  | 40.500 |
| 64  | 4 | 64 | 2 | 4096 | 8 | 64  | 50.500 |
| 64  | 8 | 64 | 2 | 2048 | 8 | 64  | 45.500 |
| 64  | 8 | 64 | 2 | 4096 | 8 | 64  | 55.500 |
| 128 | 4 | 64 | 2 | 2048 | 8 | 64  | 41.750 |
| 128 | 4 | 64 | 2 | 4096 | 8 | 64  | 51.750 |
| 128 | 8 | 64 | 2 | 2048 | 8 | 64  | 46.750 |
| 128 | 8 | 64 | 2 | 4096 | 8 | 64  | 56.750 |
| 64  | 4 | 64 | 2 | 2048 | 8 | 128 | 48.500 |
| 64  | 4 | 64 | 2 | 4096 | 8 | 128 | 58.500 |
| 64  | 8 | 64 | 2 | 2048 | 8 | 128 | 53.500 |
| 64  | 8 | 64 | 2 | 4096 | 8 | 128 | 63.500 |
| 128 | 4 | 64 | 2 | 2048 | 8 | 128 | 49.750 |
| 128 | 4 | 64 | 2 | 4096 | 8 | 128 | 59.750 |
| 128 | 8 | 64 | 2 | 2048 | 8 | 128 | 54.750 |
| 128 | 8 | 64 | 2 | 4096 | 8 | 128 | 64.750 |


Στην πραγματικότητα όμως δεν μας απασχολεί ούτε αποκλειστικά η μεγιστοποίηση των επιδόσεων του κάθε config, ούτε αποκλειστικά η ελαχιστοποίηση του κόστους, αλλά το βέλτιστο tradeoff μεταξύ αυτών.

Έτσι, ίσως πιο αποδοτική μετρική αποτελεί το γινόμενο του **cost function** με το **CPI** του κάθε configuration σε κάθε benchmark. Παρακάτω παρουσιάζουμε εναν πίνακα με το μέτρο αυτό για κάθε config.

| bzip             | mcf              | Hmmer            | Sjeng            | Libm             |
|------------------|------------------|------------------|------------------|------------------|
| ```80.187``` | 61.524 | ``56.268`` | 651.829                          | 176.417 |
| 95.112 | ```58.191``` | 68.146 | 703.184                              | 211.119 |
| 84.417 | 63.967 | 59.823 | 715.975                                    | 193.884 |
| 99.091 | 58.349 | 71.699 | 767.339                                    | 228.566 |
| 89.095 | 61.796 | 59.964 | ``485.856``                                | 198.251 |
| 103.550 | 67.571 | 71.839 | 519.842                                   | 232.928 |
| 93.605 | 65.550 | 63.527 | 528.318                                    | 215.718 |
| 107.916 | 69.015 | 75.401 | 562.302                                   | 250.376 |
| 92.871 | 74.790 |                  |                                  | ``151.005`` |
| 107.998 |                  |                  |                       | 176.496 |
| 96.886 |                  |                  |                        | 163.911 |
| 111.799 |                  |                  |                       | 189.379 |
| 101.315 |                  |                  |                       | 167.138 |
...
Εντοπίζοντας τα **minn** για κάθε Benchmark καταλαβαίνουμε πιο configuration είναι το βέλτιστο ως προς κόστος και χρόνο εκτέλεσης καιτελικά επιλέγουμε για το:

### Bzip2

|L1d Size|l1d Assoc|l1i Size|l1i Assoc|l2 Size|l2 Assoc|Cache Line| Cost * CPI |
|--------|----------|------------------|------------------|--------|----------|--------|----------|
| 64  | 2 | 64 | 2 | 2096 | 8 | 64  |80.187 |

### Mcf

|L1d Size|l1d Assoc|l1i Size|l1i Assoc|l2 Size|l2 Assoc|Cache Line| Cost * CPI |
|--------|----------|------------------|------------------|--------|----------|--------|----------|
| 64 | 4 | 32  | 4 | 2048 | 8 | 64 | 58.191 |

### Hmmer

|L1d Size|l1d Assoc|l1i Size|l1i Assoc|l2 Size|l2 Assoc|Cache Line| Cost * CPI |
|--------|----------|------------------|------------------|--------|----------|--------|----------|
| 64 | 4 | 32 | 2 | 2048 | 8 | 64 | 56.268 |

### Sjeng

|L1d Size|l1d Assoc|l1i Size|l1i Assoc|l2 Size|l2 Assoc|Cache Line| Cost * CPI |
|--------|----------|------------------|------------------|--------|----------|--------|----------|
| 64  | 4 | 64 | 4 | 4096   | 8       | 128 | 485.856 |

### Libm

|L1d Size|l1d Assoc|l1i Size|l1i Assoc|l2 Size|l2 Assoc|Cache Line| Cost * CPI |
|--------|----------|------------------|------------------|--------|----------|--------|----------|
| 64  | 4 | 64 | 2 | 2048 | 8 | 128 | 151.005 |


## **Σχόλια**

H παραπάνω προσπάθεια αξιολόγησης και βελτιστοποίησης των επεξεργαστών μας για τα benchmarks του Specc βασίζεται σε λίγες πληροφορίες κοστολόγησης που υπάρχουν διαθέσιμες και την περιορισμένη αντιληψη μας επι του θέματος.

Αν και αποτελεί μια λεπτομερής προσπαθεια , δεν είναι απόλυτα ενδεικτική και παρουσιάζει κάποιες αδυναμίες τις οποίες μπορόυμε να εντοπίσουμε στα εξής σημεία:

 * Αρχικά, ο περιορισμός σε χρόνο περιόρισε και τον χώρο δοκιμών μας ακόμα και για τον μικρό αριθμό παραμέτρων. Συνεπώς, σε διαφορετικά Benchmarks έχουμε διαφορετικούς βαθμούς μεταβολής του CPI, των miss rates και του χρόνου εκτέλεσης συνολικά.
 
 * Επιπλέον, η δημιουργία μιας συνεπούς συνάρτησης κόστους αποτελεί ιδιαίτερα σύνθετο και δύσκολο task. Πρακτικά, παίζουν πολλές περισσότερες παράμετροι, πέρα των ελάχιστων ποσοτικών παραμέτρων που είχαμε σαν βαθμούς ελευθερίας, στην διαμόρφωση μιας ρεαλιστικής συνάρτησης κόστους.

 * Τέλος, η εύρεση του βέλτιστου config μέσω του CPI και του Cost Function παρουσιάζει πολύ μικρή ευαισθησία. Συνεπώς στις περιπτώσεις με μεγάλες διακυμάνσεις είναι ικανοποιητικό μέτρο το ```Cost x CPI``` (π.χ. Sjeng, Libm) ενώ σε άλλες περιπτώσεις χωράνε αμφιβολίες για το κατα πόσο επιλέγει το βέλτιστο Configuration.

## **References:**

1. [Reducing Miss Rates. ECE University of New Mexico](http://ece-research.unm.edu/jimp/611/slides/chap5_3.html)
2. [Cache Desgin. CSE240A UC San Diego](https://cseweb.ucsd.edu/classes/fa10/cse240a/pdf/08/CSE240A-MBT-L15-Cache.ppt.pdf)
