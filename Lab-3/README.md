...
Σε γενικές γραμμές τo χαμηλό CPI ενός config συνοδεύεται και απο αντιστοιχα χαμηλό EDAP με κάποιες λίγες εξαιρέσεις. Επομένως ο συνδιασμός των 2 αυτών μετρικών μπορεί να αποτελέσει καλό κρητήριο της απόδοσης ενος επεξεργαστή.
